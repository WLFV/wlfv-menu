local QBCore = exports['wlfv-core']:GetCoreObject()
...
RegisterNetEvent('wlfv-menu:client:openMenu', function(data)
    openMenu(data)
end)

RegisterNetEvent('wlfv-menu:client:closeMenu', function()
    closeMenu()
end)
